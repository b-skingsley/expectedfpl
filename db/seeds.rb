...
Player.create!(team: team, bench_pos: 1, footballer: Footballer.where(web_name: "Dalot", position: "DEF").first)
Player.create!(team: team, starter: true, footballer: Footballer.where(web_name: "Sancho", position: "MID").first)
