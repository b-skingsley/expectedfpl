# Backup for the fixture task (This file can be removed if the task file works fine for every scenario)
# !!This code only works for predicting the goals for the HOME team (edit this line if this information is no longer true)
...
class Predictions
  ...
  p prediction(ht_number_of_games_at_home, ht_season_total_goals_scored_at_home, ht_season_total_goals_conceded_at_home, at_number_of_games_away, at_season_total_goals_scored_away, at_season_total_goals_conceded_away, leagues_home_matches, leagues_away_matches, leagues_home_goals, leagues_away_goals, leagues_conceded_home_goals, leagues_conceded_away_goals)
